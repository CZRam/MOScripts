use cram;
CREATE TABLE IF NOT EXISTS mo_xmms_summary_group(
record_id	bigint,
hdd_date	date,
media_date	date,
load_date	timestamp,
...
defects map<string, double>,
incominghead map<string, double>,
interface map<string, double>,
magnetic map<string, double>
)
...
interface:,
magnetic:")
TBLPROPERTIES ("hbase.table.name" = "mo_xmms_summary_group");