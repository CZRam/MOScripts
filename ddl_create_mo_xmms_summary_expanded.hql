use cram;
CREATE TABLE IF NOT EXISTS mo_xmms_summary_expanded( 
hbase_rowkey struct<record_id:bigint,param_group_nm:string,param_id:int>,
record_id    bigint,
hdd_date    date,
media_date    date,
load_date    timestamp,
...
header:param_id,
header:param_value")
TBLPROPERTIES ("hbase.table.name" = "mo_xmms_summary_expanded");